    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "gilosh_handmade משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1d644780-5d5c-4fe0-9b9c-ba51ddfddd16',
                    name: data.name || '',
                    email: data.email || '',
